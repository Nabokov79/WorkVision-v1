package ru.nabokovsg.gateway.controller.laboratoryNK.equipmentDiagnosed;
...
import ru.nabokovsg.gateway.client.laboratoryNK.equipmentDiagnosed.EquipmentPassportClient;
import ru.nabokovsg.gateway.dto.laboratoryNK.equipmentDiagnosed.passport.NewEquipmentPassportDto;
import ru.nabokovsg.gateway.dto.laboratoryNK.equipmentDiagnosed.passport.UpdateEquipmentPassportDto;

@RestController
@RequestMapping(
        value = "/WorkVisionWeb/nk/diagnosed/equipments/passport",
