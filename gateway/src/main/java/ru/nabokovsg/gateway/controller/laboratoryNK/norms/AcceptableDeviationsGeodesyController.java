...
import ru.nabokovsg.gateway.client.laboratoryNK.norms.AcceptableDeviationsGeodesyClient;
import ru.nabokovsg.gateway.dto.laboratoryNK.norms.geodesy.NewAcceptableDeviationsGeodesyDto;
import ru.nabokovsg.gateway.dto.laboratoryNK.norms.geodesy.UpdateAcceptableDeviationsGeodesyDto;

@RestController
@RequestMapping(
        value = "/WorkVisionWeb/nk/equipment/norms/geodesy",
