...
import ru.nabokovsg.gateway.client.laboratoryNK.norms.ElementRepairClient;
import ru.nabokovsg.gateway.dto.laboratoryNK.norms.elementRepair.NewElementRepairDto;
import ru.nabokovsg.gateway.dto.laboratoryNK.norms.elementRepair.UpdateElementRepairDto;

@RestController
@RequestMapping(
        value = "/WorkVisionWeb/nk/equipment/norms/repair",
