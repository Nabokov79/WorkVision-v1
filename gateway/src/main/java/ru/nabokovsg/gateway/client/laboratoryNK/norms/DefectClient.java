...
import ru.nabokovsg.gateway.dto.laboratoryNK.norms.defects.NewDefectDto;
import ru.nabokovsg.gateway.dto.laboratoryNK.norms.defects.UpdateDefectDto;

@Service
public class DefectClient extends BaseClient {

    private static final String API_PREFIX = "/norms/defect";
    private static final String DELIMITER = "/";

    @Autowired
    public DefectClient(@Value("${laboratoryNK-server.url}") String baseUrl) {
