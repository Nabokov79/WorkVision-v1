...
CREATE TABLE IF NOT EXISTS VM_SURVEYS
(
    id                BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    survey_journal_id BIGINT                                  NOT NULL,
    equipment_id      BIGINT                                  NOT NULL,
    ...
    part_name         VARCHAR,
    inspection        VARCHAR,
    CONSTRAINT pk_vmSurvey PRIMARY KEY (id)
);
...
(
    ...
    CONSTRAINT FK_DEFECT_MEASUREMENTS_ON_VM_SURVEYS FOREIGN KEY (vm_id) REFERENCES vm_surveys (id)
);
