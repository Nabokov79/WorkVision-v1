...
CREATE TABLE IF NOT EXISTS EQUIPMENT_SURVEYS
(
    id                BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    survey_journal_id BIGINT                                  NOT NULL,
    equipment_id      BIGINT                                  NOT NULL,
    ...
    part_name         VARCHAR,
    inspection        VARCHAR,
    CONSTRAINT pk_equipmentSurvey PRIMARY KEY (id)
);
...
(
    ...
    equipment_survey_id                   BIGINT                                  NOT NULL,
    CONSTRAINT pk_defectMeasurement PRIMARY KEY (id),
    CONSTRAINT FK_DEFECT_MEASUREMENTS_ON_VM_SURVEYS FOREIGN KEY (equipment_survey_id) REFERENCES equipment_surveys (id)
);
